...
import net.apucsw.mcrssmod.inventory.container.ModPlayerContainer;
...
public class InventoryWearableDeviceSlot extends Slot {
	...
	{
		return Pair.of(AtlasTexture.LOCATION_BLOCKS_TEXTURE, ModPlayerContainer.EMPTY_WEARABLE_DEVICE_SLOT);
	}
}
