...
package net.apucsw.mcrssmod.gui;
...
public class UserDataStatusGuiWindow extends ContainerScreen<UserDataStatusGui.GuiContainerMod> {
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("mcrssmod:textures/gui/bar/battery_value_normal.png"));
